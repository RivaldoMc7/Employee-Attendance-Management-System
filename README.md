...
| ID\_EMPLEADO\_TE   | Employee ID      |

| NOMBRE           | First name       |

| APELLIDO\_PATERNO | Last name        |

| APELLIDO\_MATERNO | Second last name |
...
| ID\_PUESTO     | Position ID   |

| NOMBRE\_PUESTO | Position name |
