...
Additionally, the system calculates attendance bonuses based on completed attendance cycles and stores all records in a SQL Server database.

This project was developed as part of an Object-Oriented Programming course and demonstrates the implementation of database connectivity, object-oriented design, desktop user interfaces, and CRUD operations.
...
Query classes and database connection classes are reused across the project.
